...
dwv.tool.DrawLineCommand = function(points, app, style)
{
    ...
    this.execute = function()
    {
        ...
        if (TA_SELECTED_PARAMETER_ID) {
          var inputParam = document.getElementById(TA_SELECTED_PARAMETER_ID);
          inputParam.value = Math.round(length);
          // Trigger update
          $('#parametersdiv').find('button').click()
        }
