...
$(document).ready( function()
{
    ...
    $(TRACHEAL_AIRE.INPUTS_DIV).dialog({ position:
        {my: "right center", at: "right top", of: "#pageMain"},
        autoOpen: true, width: 350, height: 350 });

    $(TRACHEAL_AIRE.VIEWER_DIV).dialog({ position:
        {my: "right bottom", at: "right bottom", of: "#pageMain"},
        autoOpen: true, width: 640, height: 400 });


    // image dialog
    $("#layerDialog").dialog({ position:
        {my: "left-300 top", at: "center top", of: "#pageMain"},
        autoOpen: true, width: 500, height: 500 });
    // default size
    $("#layerDialog").dialog({ width: "auto", resizable: true });
    // Makes the layer dialog widget have a min width for collapsing
    $('#layerDialog').parent().css({'min-width': 371});
